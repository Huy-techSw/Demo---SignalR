...
namespace FA24_PRN221_3W_G3_KoiCareSystemAtHome.Repositories
{
    ...
    {
        protected FA24_PRN221_3W_G3_KoiCareSystemAtHomeContext _context;

        public GenericRepository()
        {
            _context ??= new FA24_PRN221_3W_G3_KoiCareSystemAtHomeContext();
        }

        public GenericRepository(FA24_PRN221_3W_G3_KoiCareSystemAtHomeContext context)
        {
            _context = context;
        }
